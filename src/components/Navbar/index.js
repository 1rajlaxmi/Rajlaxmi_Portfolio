...
import { Nav, NavLink, NavbarContainer, Span, NavLogo, NavItems, GitHubButton, ButtonContainer, MobileIcon, MobileMenu, LinkedinButton, MobileNavLogo, MobileLink } from './NavbarStyledComponent'
      ...
      <NavbarContainer>
        <NavLogo to='/'>
          <a style={{ display: "flex", alignItems: "center", color: "white", marginBottom: '20;', cursor: 'pointer' }}>
            <DiCssdeck size="3rem" /> <Span>Rajlaxmi</Span>
          </a>
        </NavLogo>
        <MobileIcon>
          <FaBars onClick={() => {
